...
public class sudokuSegmantation {
    ...
    public sudokuSegmantation() {

        try {
            File input = new File("/home/bikash/Desktop/sodukuImage/5.png");
    ...
    static public void main(String args[]) throws Exception {
        ...
        sudokuSegmantation obj = new sudokuSegmantation();
        ...
        BufferedImage numTiles[][] = imagetomatrix(ImageIO.read(new File("/home/bikash/Desktop/sodukuImage/5.png")),horizontalSliceIndex,verticalSliceIndex,9);
            ...
            for (int row=0; row<9; row++){
                ...
                for (int i=0; i<numTiles[row][col].getHeight(); i++){
                    for (int j = 0; j < numTiles[row][col].getWidth(); j++) {
                        Color c = new Color(numTiles[row][col].getRGB(j, i));
     ...
     //           showImage(numTiles[row][col],"test");
                System.out.print(network.predict(imgLinear,network)+" ");
            }
            System.out.println();
        }
        showImage(numTiles[0][1],"test");
    }
    ...
    public static BufferedImage[][] imagetomatrix(BufferedImage image, int[] hSlice, int[] vSlice, int size) {
