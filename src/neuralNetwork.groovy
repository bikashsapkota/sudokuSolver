...
public class neuralNetwork {
    ...
    neuralNetwork(def inputnodes=784,def hiddennodes=100,def outputnodes=10,def learningrate=0.2){
        ...
        this.wih = readcsv("/home/bikash/IdeaProjects/sudokuSolver/src/wih.csv",new Matrix(this.hiddennodes,this.inputnodes))
        this.who = readcsv("/home/bikash/IdeaProjects/sudokuSolver/src/who.csv",new Matrix(this.outputnodes,this.hiddennodes))
    ...
    public static void main(String[] args) {
        ...
        def testData = new File('/home/bikash/IdeaProjects/sudokuSolver/data1.csv').getText();
        ...
        println("Accuracy: "+correct/81*100+"%")
    }
